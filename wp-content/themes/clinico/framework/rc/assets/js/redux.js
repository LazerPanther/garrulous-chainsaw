...
jQuery(document).ready(function($) {
	...
	function redux_expand_options(parent) {
		...
		var width = parent.find('.redux-sidebar').outerWidth();
		var id = jQuery('.redux-group-menu .active a').data('rel') + '_section_group';
		var rtl = redux_is_rtl();
		var main = parent.find('.redux-main');
		var sidebar = parent.find('.redux-sidebar');

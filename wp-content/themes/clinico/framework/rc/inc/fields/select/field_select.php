	...
	*/
	function render(){
		...
		if( !empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
			...
			if ($this->field['data'] == "elusive-icons" || $this->field['data'] == "fa-icons" ) {
				$icons_file = ReduxFramework::$_dir."inc/fields/select/{$this->field['data']}.php";
		...
		if ( !empty($this->field['data']) && ( $this->field['data'] == "elusive-icons" ) ) {
			$this->field['class'] = " font-icons";
		} elseif ( !empty($this->field['data']) && ( $this->field['data'] == "fa-icons" ) ) {
			$this->field['class'] = " font-icons-fa";
		}

    ...
    class ReduxFramework_group {
        ...
        */
        public function render() {
            ...
            echo "<span class='description'>".$this->field["subtitle"]."</span></div></th><td>";
            echo "<fieldset id='".$this->parent->args['opt_name']."-".$this->_check_empty_field('id')."-fieldset' class='redux-field-container redux-field redux-container-group'>";
        ...
        function add_subfields($index, $use_default_values = false){
            ...
            foreach ($this->field["subfields"] as $subfield) {
                ...
                if(!isset($subfield["class"]))$subfield["class"]="";
